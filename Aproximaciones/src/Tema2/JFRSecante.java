 ...
 * @author Eliel Novelo
 */
public class JFRSecante extends javax.swing.JDialog {

    /**
     * Creates new form dlgSecante
     */
    public JFRSecante(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFRSecante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JFRSecante dialog = new JFRSecante(new javax.swing.JFrame(), true);
